...
// NewWebParsingConnector defines a go-colly collector, the collector is used by all the connector that does web scraping
func NewWebParsingConnector(logger *logging.Logger, name string) (*colly.Collector, error) {
