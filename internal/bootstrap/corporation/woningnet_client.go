...
func CreateWoningNetClient(logger *logging.Logger, mapboxClient mapbox.Client, corporation corporation.Corporation) connector.Client {
	// add cookie jar
	...
	return woningnet.NewClient(logger, httpClient, mapboxClient, corporation)
}
